...
Sub Final_1()
    ...
    'Dim WorksheetName_1 As String
    'Dim WorksheetName_2 As String
    'Dim WorksheetName_3 As String
    Dim i As Integer
    Dim j As String
    ...
    'Dim Tag_15, Tag_16, Tag_17 As String
    ...
    MinVal = 0
    MaxVol = 0
    'WorksheetName_1 = ws.ActiveSheet.Name
    'WorksheetNam_2 = ws.ActiveSheet.Name
    'WorksheetName_3 = ws.ActiveSheet.Name
